...
function ProductCard({dashboardData, Icon}) {
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="px-5 py-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">{t("Products")}</h2>
        </header>
        ...
        <div className="flex items-center flex justify-between">
          <div className="text-3xl font-bold text-slate-800 dark:text-slate-100 mr-2">{dashboardData?.productConut}</div>
          <div className="pt-2 ">
            <Link to={'products?action=add'}  className="flex justify-start">
